...
test("part 1 sample input is correct", () => {
  expect(solution.one(solution.parse(sampleInput))).toBe(13);
});

test("part 2 sample input is correct", () => {
  expect(solution.two(solution.parse(sampleInput))).toBe(1);
});
...
test("part 1 real input is correct", () => {
  expect(solution.one(solution.parse(realInput))).toBe(5878);
});

test("part 2 real input is correct", () => {
  expect(solution.two(solution.parse(realInput))).toBe(2405);
});
